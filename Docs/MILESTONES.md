...
- [ ] **Week 6:** Ship day/night clock, stamina loop, and weather-driven moisture.
- [ ] **Week 7:** Expand Homestead content set (crops, tools, starter structures, inventory hooks).
